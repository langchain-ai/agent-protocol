...
- [Self-hosted async subagent server (TypeScript)](https://github.com/langchain-ai/deepagentsjs/tree/alpha/examples/async-subagent-server) - a TypeScript example of a self-hosted agent implementing this protocol, designed to be invoked as an async subagent
