...
class RunsApi:
    ...
    def update_and_stream_run(
        ...
        :type run_id: str
        :param run_update: (required)
        :type run_update: RunUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_and_stream_run_serialize(
            run_id=run_id,
    ...
    @validate_call
    def update_and_stream_run_with_http_info(
        self,
        run_id: Annotated[StrictStr, Field(description="The ID of the run.")],
        run_update: RunUpdate,
        _request_timeout: Union[
    ...
    @validate_call
    def update_and_stream_run_without_preload_content(
        self,
        run_id: Annotated[StrictStr, Field(description="The ID of the run.")],
        run_update: RunUpdate,
        _request_timeout: Union[
    ...
    def _update_and_stream_run_serialize(
        self,
        run_id,
        run_update,
        _request_auth,
    ...
    def update_and_wait_run(
        ...
        _param = self._update_and_wait_run_serialize(
            run_id=run_id,
            run_update=run_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_and_wait_run_with_http_info(
        self,
        run_id: Annotated[StrictStr, Field(description="The ID of the run.")],
        run_update: RunUpdate,
        _request_timeout: Union[
    ...
    @validate_call
    def update_and_wait_run_without_preload_content(
        self,
        run_id: Annotated[StrictStr, Field(description="The ID of the run.")],
        run_update: RunUpdate,
        _request_timeout: Union[
    ...
    def _update_and_wait_run_serialize(
        self,
        run_id,
        run_update,
        _request_auth,
