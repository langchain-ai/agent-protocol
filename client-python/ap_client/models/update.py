...
UPDATE_ANY_OF_SCHEMAS = ["List[object]", "object"]
...
class Update(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = Update.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in Update with anyOf schemas: List[object], object. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into Update with anyOf schemas: List[object], object. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
