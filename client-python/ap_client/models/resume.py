...
RESUME_ANY_OF_SCHEMAS = ["List[object]", "bool", "float", "object", "str"]
...
class Resume(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in Resume with anyOf schemas: List[object], bool, float, object, str. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into Resume with anyOf schemas: List[object], bool, float, object, str. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
